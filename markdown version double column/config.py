...
DEFAULT_IMAGE_SIZE = 70  # Configurable default image size (can be increased without text overflow)
...
PAGE_WIDTH, PAGE_HEIGHT = 420, 595  # A5 size in points (148mm × 210mm)
MARGINS = (28, 28, 28, 28)   # left, top, right, bottom (in points)
...
CHAPTER_HEADER_FONT_SIZE = 12                    # Font size for chapter headers
